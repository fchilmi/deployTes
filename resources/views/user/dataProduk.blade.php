<x-layout>
    ...
    <div class="min-h-full">
        <main>
            ...
            <div class="mx-auto max-w-7xl px-4 py-2  sm:px-6 lg:px-8 shadow">

                <!--Card-->
                <div id='recipients' class="p-8 mt-1 lg:mt-0 rounded  bg-white">
                    <div class="mb-4">
                        <button id="defaultModalButton" data-modal-target="ModalAddProduk"
